...
export const getService = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        next({ statusCode: 404, message: 'Error fetching service: ' + e.message });
    }
};
...
export const putService = async (req: Request, res: Response,next: NextFunction) => {
    try {
...
export const deleteService = async (req: Request, res: Response,next: NextFunction) => {
    try {
        ...
        next( { statusCode: 404, message: 'Error deleting service: ' + e.message });
    }
};
